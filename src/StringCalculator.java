	...
	int[] intArray = new int[stringArray.length];
		...
		try {
			for (int i = 0; i < stringArray.length; i++) {
				...
				{
					throw new StringCalculatorException("Nije moguce vrsiti datu operaciju sa negativnim brojevima", null);
				}
			...
			throw new StringCalculatorException("Dati input nije validan", null);
		}
